...
import com.fpt.duantn.io.repository.*;
...
public class SendMailUtil {
    ...
    public void sendMailOrder(BillEntity bill) {
        SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
        List<BillDetailEntity> listOrderDetails = billDetailService.findByBillId(bill.getId());
        StringBuilder content = new StringBuilder();
        content.append(HEADER);
        for (BillDetailEntity oderDetail : listOrderDetails) {
            content.append("<tr>\r\n"
                    ...
                    + oderDetail.getProductDetail().getProduct().getProductName() + " </td>\r\n"
                    + "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;\"> "
        ...
        content.append(
                "<td width=\"55%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee;\"> Tổng tiền: </td>\r\n"
                        ...
                        + format(String.valueOf(billDetailService.sumQuantityByBillIdAndType(bill.getId(),1))) + " </td>");
        ...
        content.append(
                "<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
                        ...
                        + "                                                            <p>"
                        + dt.format(bill.getCreateDate()) + "</p>\r\n"
                        + "                                                        </td>\r\n"
                        + "                                                    </tr>\r\n"
                        + "                                                </table>\r\n"
                        + "                                            </div>\r\n"
                        ...
                        + "                                                            <p>" + bill.getCustomer().getFirstName() + bill.getCustomer().getLastName()
                        + "</p>\r\n" + "                                                        </td>\r\n"
                        + "                                                    </tr>\r\n"
                        + "                                                </table>\r\n"
                        + "                                            </div>\r\n"
    ...
    public void sendMailOrderSuccess(BillEntity order) {
        SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
        List<BillDetailEntity> listOrderDetails = billDetailService.findByBillId((order.getId()));
        StringBuilder content = new StringBuilder();
        ...
        for (BillDetailEntity oderDetail : listOrderDetails) {
            content.append("<tr>\r\n"
                    + "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;text-align: center;\">\r\n"
                    + "                                                        <img style=\"width: 85%;\" src="
//					+ oderDetail.getgetProduct().getImage() + ">\r\n"
                    + "                                                    </td>\r\n"
                    + "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;\"> "
                    + oderDetail.getProductDetail().getProduct().getProductName() + " </td>\r\n"
                    + "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;\"> "
        ...
        content.append(
                "<td width=\"55%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee;\"> Tổng tiền: </td>\r\n"
                        + "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee; color: red;\"> "
                        + format(String.valueOf(billDetailService.sumQuantityByBillIdAndType(order.getId(),1))) + " </td>");
        content.append(BODY3);
        content.append(
                "<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
                        + "                                                            <p style=\"font-weight: 800;\">Địa chỉ giao hàng</p>\r\n"
                        ...
                        + "                                                            <p style=\"font-weight: 800;\">Ngày đặt hàng</p>\r\n"
                        + "                                                            <p>"
                        + dt.format(order.getCreateDate()) + "</p>\r\n"
                        + "                                                        </td>\r\n"
                        + "                                                    </tr>\r\n"
                        + "                                                </table>\r\n"
                        + "                                            </div>\r\n"
                        ...
                        + "                                                        <td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
                        + "                                                            <p style=\"font-weight: 800;\">Tên người nhận</p>\r\n"
                        + "                                                            <p>" + order.getCustomer().getFirstName() +order.getCustomer().getLastName()
                        + "</p>\r\n" + "                                                        </td>\r\n"
                        + "                                                    </tr>\r\n"
                        + "                                                </table>\r\n"
                        + "                                            </div>\r\n"
                        ...
                        + "</p>\r\n" + "                                                        </td>");
        content.append(FOOTER);
        sendMailService.queue(order.getCustomer().getEmail(), "Thanh toán thành công", content.toString());
    }


    public void sendMailOrderDeliver(BillEntity order) {
        SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
        List<BillDetailEntity> listOrderDetails = billDetailService.findByBillId(order.getId());
        StringBuilder content = new StringBuilder();
...
//					+ oderDetail.getProduct().getImage() + ">\r\n"
        ...
        content.append(
                "<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
                        ...
                        + "</p>\r\n" + "                                                        </td>");
        content.append(FOOTER);
        sendMailService.queue(order.getCustomer().getEmail(), "Đơn hàng đã được xác nhận", content.toString());
    }

    public void sendMailOrderCancel(BillEntity order) {
        SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
        List<BillDetailEntity> listOrderDetails = billDetailService.findByBillId(order.getId());
        StringBuilder content = new StringBuilder();
...
//					+ oderDetail.getProduct().getImage() + ">\r\n"
        ...
        content.append(
                "<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
                        ...
                        + "</p>\r\n" + "                                                        </td>");
        content.append(FOOTER);
        sendMailService.queue(order.getCustomer().getEmail(), "Huỷ đơn thành công", content.toString());
    }
    ...
    static String HEADERDELIVER = "<body style=\"margin: 0 !important; padding: 0 !important; background-color: #fcb800;\" bgcolor=\"#fcb800\">\r\n"
            ...
            + "                                            <img src=\"https://res.cloudinary.com//image/upload/v1647788678/users/j53qiooahnkiq2jmz9lk.png\" width=\"220px\"/>\r\n"
            + "                                        </td>\r\n" + "                                    </tr>\r\n"
            + "                                </table>\r\n" + "                            </div>\r\n"
            + "                            \r\n" + "                        </td>\r\n" + "                    </tr>\r\n"
            + "                    <tr>\r\n"
    ...
    static String FOOTER = "</tr>\r\n" + "                                                </table>\r\n"
            ...
            + "                                            <p style=\"font-size: 18px; font-weight: 800; line-height: 18px; color: #fcb800;\"> Shop ban giày </p>\r\n"
